...
<body class="light">
  ...
  <div class="grid-container">
    ...
    <!-- RPLife -->
    <div id="rplife" class="grid-100 block block-blue">
    ...
    <!-- Habitudes -->
    <div class="grid-100 block block-yellow">
      <div class="grid-66">
    ...
    <!-- Majordome -->
    <div id="majordome" class="grid-100 block block-green">
      <div class="grid-33 hide-on-mobile margin-top-32" style="position: relative; display: block; height: 348px;">
      ...
      <div class="grid-66">
        ...
        <h3 class="white">Your own household assistant</h3>
    ...
    <!-- Support -->
    <div class="grid-100 block block-white">
